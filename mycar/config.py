...
IMAGE_W = 200   # og 160  max = 2592
IMAGE_H = 160   # og 120 max = 1944 | 160deg FOV
...
ROI_CROP_TOP = 80 #og 60 for 120 image_height  # the number of rows of pixels to ignore on the top of the image
...
IMU_DLP_CONFIG = 0x05              # Digital Lowpass Filter setting (0:250Hz, 1:184Hz, 2:92Hz, 3:41Hz, 4:20Hz, 5:10Hz, 6:5Hz)
...
BEHAVIOR_LIST = ['Left', 'Right','Stop']
BEHAVIOR_LED_COLORS = [(0, 10, 0), (10, 0, 0), (0,0,10)]  #RGB tuples 0-100 per chanel
