...
ROI_CROP_TOP = 138 #og 60 for 120 image_height  # the number of rows of pixels to ignore on the top of the image
...
IMU_DLP_CONFIG = 5              # Digital Lowpass Filter setting (0:250Hz, 1:184Hz, 2:92Hz, 3:41Hz, 4:20Hz, 5:10Hz, 6:5Hz)
